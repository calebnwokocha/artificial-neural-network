...
public class Audio extends Thread {
	...
	public Audio(File audioFile) throws IOException, UnsupportedAudioFileException {
		this.ais = javax.sound.sampled.AudioSystem.getAudioInputStream(audioFile);
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public Audio(File audioFile, LineListener lineListener) throws IOException, UnsupportedAudioFileException {
		this.ais = javax.sound.sampled.AudioSystem.getAudioInputStream(audioFile);
	 ...
	 * @param lineListener
	 */
	public Audio(AudioInputStream ais, LineListener lineListener) {
		this.ais = ais;
		this.lineListener = lineListener;
	}
	 ...
	 * @throws UnsupportedAudioFileException
	 */
	public Audio(File audioFile, SourceDataLine line, LineListener lineListener) throws IOException, UnsupportedAudioFileException {
		this.ais = javax.sound.sampled.AudioSystem.getAudioInputStream(audioFile);
		this.line = line;
		this.lineListener = lineListener;
	}
	 ...
	 * @param lineListener
	 */
	public Audio(AudioInputStream ais, SourceDataLine line, LineListener lineListener) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
	}
	 ...
	 */
	public Audio(File audioFile, SourceDataLine line, LineListener lineListener, int outputMode) throws IOException, UnsupportedAudioFileException {
		this.ais = javax.sound.sampled.AudioSystem.getAudioInputStream(audioFile);
		this.line = line;
		this.lineListener = lineListener;
	 ...
	 *            stereo output, or mute the right channel of a stereo signal; if RIGHT_ONLY, do the same with the right output channel.
	 */
	public Audio(AudioInputStream ais, SourceDataLine line, LineListener lineListener, int outputMode) {
		this.ais = ais;
		this.line = line;
		this.lineListener = lineListener;
		this.outputMode = outputMode;
	...
	public void run() {
		...
		try {
			if (line == null) {
				boolean bIsSupportedDirectly = javax.sound.sampled.AudioSystem.isLineSupported(info);
